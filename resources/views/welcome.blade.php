...
<div class="wrapper bgded" style="background-image:url('images/demo/front.png')">
    <div id="pageintro" class="hoc clear">
        <!-- ################################################################################################ -->
        <article>
            <div class="overlay inspace-30 btmspace-30">
                <h2 class="heading">прайс-лист</h2>
                <p>
                    Скачать прайс-лист можно по следующей ссылке, что позволит вам легко и удобно изучить предложения в любое время.
                </p>
            </div>
            <footer>
                <ul class="nospace inline pushright">
                    <li><a class="btn" href="#">Скачать</a></li>
                    <li><a class="btn inverse" href="#">Подписаться на рассылку</a></li>
                </ul>
            </footer>
        </article>
        <!-- ################################################################################################ -->
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('images/demo/bottom.png');">
        ...
        <ul class="nospace group">
            <li class="one_third first">
                <article class="element">
                    <figure><img src="images/demo/front.png" alt="">
